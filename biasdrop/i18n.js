...
window.BiasDropI18n = (function () {
  ...
  const dict = {
    bg: {
      ...
      home_wiki_sub: "Био · албуми · песни · концерти · гайдове · блог",
      ...
      open_ytmusic: "YouTube Music",
      album_show_tracks: "Виж всички песни",
      album_tracks_count: "песни",
      album_no_tracks: "Няма наличен tracklist в demo данните - ползвай Spotify / Apple / YT Music бутоните.",
      album_modal_note: "Tracklist е фен-гайд. Линковете водят към Spotify / Apple Music / YouTube Music.",
      albums_click_hint: "Кликни албум карта, за да отвориш пълния tracklist. Streaming: Spotify, Apple Music, YouTube Music.",
      artists_trivia: "Произход, храна, напитки, fun facts",
      artists_full_bio: "Пълна биография",
      trivia_origin: "Откъде са",
      trivia_food: "Какво обичат да ядат",
      trivia_drink: "Напитки",
      trivia_fun: "Fun facts",
      bio_disclaimer: "Биографията е фен-енциклопедия от публични източници (variety, official pages, интервюта). Не е authorized biography. MV thumbnail-ите са от YouTube.",
      concerts_count: "Показани дати: {n} (фан-гайд от Ticketmaster, HYBE, Kpop Wiki, venue announcements)",
      nav_blog: "Блог",
      nav_guides: "Гайдове",
      nav_privacy: "Поверителност",
      nav_terms: "Условия",
      blog_title: "Блог за супер фенове",
      blog_sub: "30 статии на български - collecting, концерти, streaming, comeback schedule, group order, binder setup, етика и Weverse.",
      blog_read: "Прочети",
      blog_prev: "Предишна",
      blog_next: "Следваща",
      blog_posts: "статии",
      guides_title: "Evergreen гайдове за супер фенове",
      guides_sub: "Речник, photocard collecting, light sticks, streaming, първи концерт, Weverse, Season's Greetings и безопасно купуване. BG + EN.",
      guides_open: "Отвори гайда",
      guides_label: "гайда",
      guides_evergreen: "Evergreen",
      guides_also: "Още от BiasDrop",
      home_mv_title: "Официални K-pop MV-та",
      home_mv_sub: "Реални official music videos от YouTube каналите на артистите - за вайб на началната страница.",
      legal_updated: "Последна актуализация: август 2026 · BiasDrop preview (HeyLead)",
      privacy_p1: "BiasDrop е статичен preview сайт на previews.heylead.com. Не сме официален магазин на K-pop агенции.",
      privacy_h2: "Какви данни обработваме",
      privacy_p2: "Езиковата предпочитание (bg/en) и wishlist се пазят локално в localStorage на твоя браузър. Не изпращаме имейли от demo формата - съобщението е само UI. Няма сървърен акаунт.",
      privacy_h3: "Бисквитки и трети страни",
      privacy_p3: "YouTube embed-и и Pexels медия могат да задават собствени cookies/analytics според политиките на Google/Pexels. Login gate-ът на previews.heylead.com е отделен от BiasDrop съдържанието.",
      privacy_h4: "Контакт",
      privacy_p4: "За въпроси относно preview-а: martin@heylead.com. За артистични права и merch - съответните агенции и лицензирани магазини.",
      terms_p1: "Ползвайки BiasDrop, приемаш че сайтът е демо/превю с образователна и дизайн цел.",
      terms_h2: "Интелектуална собственост",
      terms_p2: "Имена, логота, MD, снимки и музика на артистите принадлежат на техните притежатели (HYBE, JYP, YG, SM, Starship, KQ и др.). Official MV-тата се показват чрез YouTube embed. Stock снимки: Pexels.",
      terms_h3: "Няма продажби тук",
      terms_p3: "Показаните цени и продукти са илюстративни. Реални покупки прави през Weverse Shop, официални shops или лицензирани retailers. Концертните дати са фен-гайд - потвърждавай при официалния продавач.",
      terms_h4: "Отговорност",
      terms_p4: "Не гарантираме пълнота на турне календари или stock. HeyLead не носи отговорност за външни сайтове, към които линкваме. Съдържанието може да се променя без предизвестие.",
    ...
    en: {
      ...
      home_wiki_sub: "Bios · albums · songs · concerts · guides · blog",
      ...
      open_ytmusic: "YouTube Music",
      album_show_tracks: "Show all songs",
      album_tracks_count: "tracks",
      album_no_tracks: "No tracklist in demo data - use Spotify / Apple / YT Music buttons.",
      album_modal_note: "Tracklist is a fan guide. Links open Spotify / Apple Music / YouTube Music.",
      albums_click_hint: "Click an album card to open the full tracklist. Stream on Spotify, Apple Music, YouTube Music.",
      artists_trivia: "Origin, food, drinks, fun facts",
      artists_full_bio: "Full biography",
      trivia_origin: "Where they are from",
      trivia_food: "Food they are known to enjoy",
      trivia_drink: "Drinks",
      trivia_fun: "Fun facts",
      bio_disclaimer: "Biography is a fan encyclopedia compiled from public sources (variety, official pages, interviews). Not an authorized biography. MV thumbnails are from YouTube.",
      concerts_count: "Showing {n} dates (fan guide from Ticketmaster, HYBE, Kpop Wiki, venue announcements)",
      nav_blog: "Blog",
      nav_guides: "Guides",
      nav_privacy: "Privacy",
      nav_terms: "Terms",
      blog_title: "Superfan blog",
      blog_sub: "30 articles in Bulgarian - collecting, concerts, streaming, comeback schedules, group orders, binder setup, ethics and Weverse.",
      blog_read: "Read",
      blog_prev: "Previous",
      blog_next: "Next",
      blog_posts: "posts",
      guides_title: "Evergreen guides for superfans",
      guides_sub: "Glossary, photocard collecting, light sticks, streaming, first concert, Weverse, Season's Greetings and safe buying. BG + EN.",
      guides_open: "Open guide",
      guides_label: "guides",
      guides_evergreen: "Evergreen",
      guides_also: "More from BiasDrop",
      home_mv_title: "Official K-pop MVs",
      home_mv_sub: "Real official music videos from the artists' YouTube channels - home-page vibe.",
      legal_updated: "Last updated: August 2026 · BiasDrop preview (HeyLead)",
      privacy_p1: "BiasDrop is a static preview site on previews.heylead.com. We are not an official K-pop agency store.",
      privacy_h2: "What data we process",
      privacy_p2: "Language preference (bg/en) and wishlist are stored in your browser localStorage only. The demo email form does not send messages - UI only. No server accounts.",
      privacy_h3: "Cookies and third parties",
      privacy_p3: "YouTube embeds and Pexels media may set their own cookies/analytics under Google/Pexels policies. The previews.heylead.com login gate is separate from BiasDrop content.",
      privacy_h4: "Contact",
      privacy_p4: "Preview questions: martin@heylead.com. For artist rights and merch - the relevant agencies and licensed retailers.",
      terms_p1: "By using BiasDrop you accept that the site is a demo/preview for education and design.",
      terms_h2: "Intellectual property",
      terms_p2: "Artist names, logos, MD, photos and music belong to their owners (HYBE, JYP, YG, SM, Starship, KQ, etc.). Official MVs appear via YouTube embed. Stock photos: Pexels.",
      terms_h3: "No sales here",
      terms_p3: "Prices and products are illustrative. Buy via Weverse Shop, official shops or licensed retailers. Concert dates are a fan guide - confirm with the official seller.",
      terms_h4: "Liability",
      terms_p4: "We do not guarantee complete tour calendars or stock. HeyLead is not responsible for external sites we link to. Content may change without notice.",
