...
window.BiasDropI18n = (function () {
  ...
  const dict = {
    bg: {
      ...
      blog_sub: "20 стартови статии на български - collecting, концерти, streaming, етика и Weverse.",
      blog_read: "Прочети",
      blog_posts: "статии",
    ...
    en: {
      ...
      blog_sub: "20 starter articles in Bulgarian - collecting, concerts, streaming, ethics and Weverse.",
      blog_read: "Read",
      blog_posts: "posts",
